...
function App() {
  ...
  if (topoPreview) {
    if (!career?.activeClimb) return <main className="mg-app"><header className="mg-header"><div><span>ALPINE LEGACY / 0.28.0</span><h1>Нет активной экспедиции</h1></div><div className="mg-header-actions"><button onClick={() => setTopoPreview(false)}>Вернуться</button></div></header></main>;
      ...
      <ScreenShell onBack={() => setScreen('MENU')} rightLabel="WORLD CREATION / 01">
        <section className="setup-grid page-enter">
          <div className="setup-intro">
            ...
            <div className="edition-stamp"><span>AL</span><strong>WORLD ENGINE</strong><small>SEED BASED / V0.28.0</small></div>
          </div>
  ...
  return (
    <ScreenShell rightLabel="EDITION 0.28.0 / INTEGRATED EXPEDITION">
